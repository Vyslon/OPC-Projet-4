    ...
    for j in range(1, 21):
        ...
        for i in range(0, nb_categories_produits):
            try:
                ...
                insertion_association = "INSERT INTO PC_C_association_table (product_id, cat_id) VALUES ({}, {}), ({}, {}), ({}, {});".format(p_id, pc_id_1, p_id, pc_id_2, p_id, pc_id_3)
                db_connection.query(insertion_prod)
                db_connection.query(insertion_association)
                p_id = p_id + 1
            except:
                pass
