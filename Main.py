...
db_connection.query("CREATE TABLE Products (id INT UNSIGNED AUTO_INCREMENT NOT NULL, name VARCHAR(100) NOT NULL, description VARCHAR(200), stores VARCHAR(100), nutrition_grade CHAR(1) NOT NULL, substituting_product_id INT UNSIGNED, url_openfoodfact VARCHAR(100) NOT NULL, PRIMARY KEY(id))")
